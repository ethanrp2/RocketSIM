...
def plotter(sim_dict, sim_dict_noisy, sim_dict_kalman, sim_error, apogee, coast_start, sim_runtime):

    plt.style.use('Solarize_Light2')


    fig,(alt_nc,vel_nc,accel_nc, error_nc) = plt.subplots(4,1,figsize=(15,10), sharex=False)
